...
static struct nic_w5100_t self;
...
static void
w5100_write__msr( uint16_t reg, uint8_t b )
{
...
void
nic_w5100_write( uint16_t reg, uint8_t b )
{
  if( reg < 0x030 ) {
    switch( reg ) {
      case W5100_MR:
