...
* `palette`: specifies the color palette to use. Can be `0` (for the RGB palette of the 128k and upward models), `1` (for the YUV palette, calculated from the voltages exposed in Chris Smith’s book), or `2` (the standard palette defined by the author).
